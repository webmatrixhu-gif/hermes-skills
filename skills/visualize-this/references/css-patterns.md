...
For AI-generated illustrations created with Hermes `image_generate`. Use sparingly for hero banners, conceptual illustrations, educational visuals, and intentional decorative accents. Embed as a base64 data URI only when the output must remain one file; otherwise deliver the image alongside the HTML.
...
Request a 16:9 landscape image for hero banners.
...
Request a square image for inline illustrations; crop responsively when a 4:3 composition is needed.
